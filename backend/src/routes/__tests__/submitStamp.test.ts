...
describe('POST /stamps/submit', () => {
  ...
  describe('1.5.2-01: 正常系 - 申請開始', () => {
    it('should start stamp submission successfully', async () => {
      // Firestore モック
      const mockStampDoc = {
        exists: true,
        data: () => ({
  ...
  describe('1.5.2-02: 異常系 - 無効なステータス', () => {
    it('should return 400 when stamp status is not generated', async () => {
      // Firestore モック
      const mockStampDoc = {
        exists: true,
        data: () => ({
