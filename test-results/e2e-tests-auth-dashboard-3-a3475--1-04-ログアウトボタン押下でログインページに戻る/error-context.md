...
- Name: 3.1 認証 → ダッシュボード >> 3.1-04 ログアウトボタン押下でログインページに戻る
- Location: C:\Users\k0803\Projects\LINEStamp\e2e\tests\auth-dashboard.spec.ts:66:7
...
Call log:
  - navigating to "/login", waiting until "load"
    ...
    at C:\Users\k0803\Projects\LINEStamp\e2e\tests\auth-dashboard.spec.ts:68:16
```
