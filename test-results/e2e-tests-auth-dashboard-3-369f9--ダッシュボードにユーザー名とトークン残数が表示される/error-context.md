...
- Name: 3.1 認証 → ダッシュボード >> 3.1-03 ダッシュボードにユーザー名とトークン残数が表示される
- Location: C:\Users\k0803\Projects\LINEStamp\e2e\tests\auth-dashboard.spec.ts:38:7
...
Call log:
  - navigating to "/login", waiting until "load"
    ...
    at C:\Users\k0803\Projects\LINEStamp\e2e\tests\auth-dashboard.spec.ts:40:16
```
