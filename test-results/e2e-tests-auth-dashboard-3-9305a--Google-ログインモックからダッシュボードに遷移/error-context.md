...
- Name: 3.1 認証 → ダッシュボード >> 3.1-02 Google ログインモックからダッシュボードに遷移
- Location: C:\Users\k0803\Projects\LINEStamp\e2e\tests\auth-dashboard.spec.ts:17:7
...
Call log:
  - navigating to "/login", waiting until "load"
    ...
    at C:\Users\k0803\Projects\LINEStamp\e2e\tests\auth-dashboard.spec.ts:19:16
```
